...
import 'package:nohunger/screen/user/screens/product/added_to_cart_message_screen.dart';
import 'package:nohunger/screen/user/screens/product/components/product_list_tile.dart';
import 'package:nohunger/screen/user/screens/product/location_permission_store_availability_screen.dart';
              ...
              slivers: [
                const SliverToBoxAdapter(
                  child: Padding(
                    ...
                    child: AspectRatio(
                      aspectRatio: 1.05,
                      child: AssetsImageWithLoader(productDemoImg1),
                    ),
                  ),
                ),
                SliverPadding(
                ...
                //     title: "Size guide",
                //     svgSrc: "assets/icons/user/Sizeguid.svg",
                ...
                SliverPadding(
                  ...
                  sliver: ProductListTile(
                    title: "Check stores",
                    svgSrc: "assets/icons/user/Stores.svg",
                    isShowBottomBorder: true,
                    press: () {
                      customModalBottomSheet(
                        context,
